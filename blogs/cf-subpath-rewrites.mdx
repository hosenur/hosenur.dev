---
title: Rewrite subdomains to subpath with Cloudflare Workers 
date: 2024-03-01
summary: Stop juggling your users between different subdomains when exploring your products, Server all apps under the same domain with Cloudflare workers.
tags:
  - Cloudflare
  - SEO
---
