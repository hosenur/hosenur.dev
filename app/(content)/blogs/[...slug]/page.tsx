...
export default async function Blog({ params }: BlogProps) {
    ...
    return (
        <article className={"prose md:prose-lg prose-pre:border prose-pre:rounded-none prose-pre:rounded-b prose-pre:shadow-lg  prose-indigo max-w-6xl prose-img:rounded"}>
            <h1 className={" font-bold text-xl md:text-2xl mb-5"}>{blog.title}</h1>
