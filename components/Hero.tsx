...
export default function Hero() {
    return (
        <div className='flex flex-col gap-2.5'>
            ...
            <p className={'text-4xl md:text-5xl ' + black.className}>Fullstack Developer, CS Student,<br />
                <Link target='_blank' className="text-indigo-300" href={"https://nur.fyi/pinterest"}>Photographer&nbsp;</Link>
                and Linux Enthusiast.</p>
